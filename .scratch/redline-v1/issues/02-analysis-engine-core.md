...
- [ ] A flag is only returned if its source sentence is an exact substring of `documentText`; otherwise it is dropped before returning (per ADR-0001) — verified by a mechanical test, not eyeballing
