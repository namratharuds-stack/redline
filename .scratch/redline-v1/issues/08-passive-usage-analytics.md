# 08: Passive usage analytics

**What to build:** Passive tracking of document-type distribution and self-identified persona (captured where onboarding or upload already asks), with no in-product payment prompt or billing UI anywhere.
